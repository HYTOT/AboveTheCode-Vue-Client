...
import { Role_VO, ManagementFormdata } from '../../util/types'
...
export default class Role extends Vue {
  ...
  private reloadStore(data:ManagementFormdata):void {
    this.$store.dispatch('setWorkspaceItem', ['角色', data])
    this.$router.go(-1)
  }
